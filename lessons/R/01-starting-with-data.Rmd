...
It gets a little annoying to type na.omit(dat$wgt) each time we want to do the calculation, so we could assign it to a new vector and then use that.

```{r}
weight <- na.omit(dat$wgt)
```
...
Let's look at just the animals of species 'AB'
